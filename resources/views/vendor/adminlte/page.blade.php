...
@section('body')
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <nav class="navbar navbar-static-top">
                <div class="container">
                    <div class="navbar-header">
                        <a href="{{ route(config('adminlte.dashboard_route', 'admin.dashboard')) }}" class="navbar-brand">
            ...
            @else
            <!-- Logo -->
            <a href="{{ route(config('adminlte.dashboard_route', 'admin.dashboard')) }}" class="logo">
